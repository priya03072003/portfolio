          ...
          <div data-aos="fade-right">
            ...
            <div className="space-y-10 border-l-4 border-dashed border-[var(--border-color)] pl-8 ml-4">
              <div className="relative group">
                ...
                <h4 className="font-bold text-xl text-[var(--color-primary)]">B.Tech AI & Data Science</h4>
                <p className="text-sm font-semibold text-[var(--text-primary)] mt-1">Builders Engineering College (2021 - 2025)</p>
